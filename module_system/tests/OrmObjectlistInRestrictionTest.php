...
class OrmObjectlistInRestrictionTest extends Testbase
{
    ...
    public function testGetStrWhere()
    {
        ...
        $objRestriction = new OrmObjectlistInRestriction("foo", $arrParams);
    ...
    public function testGetStrWhereMaxIn()
    {
        ...
        $arrParams = range(0, OrmObjectlistInRestriction::MAX_IN_VALUES);
        $objRestriction = new OrmObjectlistInRestriction("foo", $arrParams);
        $strWhere = $objRestriction->getStrWhere();
    ...
    public function testGetStrWhereMaxInBefore()
    {
        ...
        $arrParams = range(0, OrmObjectlistInRestriction::MAX_IN_VALUES - 1);
        $objRestriction = new OrmObjectlistInRestriction("foo", $arrParams);
        $strWhere = $objRestriction->getStrWhere();
    ...
    public function testQueryDatabase()
    {
        ...
        $arrParams = array();
        for ($intI = 1; $intI <= OrmObjectlistInRestriction::MAX_IN_VALUES + 10; $intI++) {
            $arrParams[] = generateSystemid();
        }
        $arrParams[] = $arrValues[0][0];

        $objRestriction = new OrmObjectlistInRestriction("temp_systemid", $arrParams);
    ...
    public function testGetStrWhere_InOrEmpty()
    {
        ...
        $arrParams = array(1, 2, 3);
        $objRestriction = new OrmObjectlistInOrEmptyRestriction("foo", $arrParams);
        $strWhere = $objRestriction->getStrWhere();
        $this->assertEquals(" AND (foo IN (?,?,?) ) ", $objRestriction->getStrWhere());
        $this->assertEquals(count($arrParams), substr_count($strWhere, "?"));


        $arrParams = array(OrmObjectlistInOrEmptyRestriction::NULL_OR_EMPTY, 1, 2, 3);
        $objRestriction = new OrmObjectlistInOrEmptyRestriction("foo", $arrParams);
        $strWhere = $objRestriction->getStrWhere();
        $this->assertEquals(" AND (foo IN (?,?,?,?) OR (foo IS NULL OR foo = '')) ", $objRestriction->getStrWhere());
        $this->assertEquals(count($arrParams), substr_count($strWhere, "?"));



        $arrParams = range(0, OrmObjectlistInRestriction::MAX_IN_VALUES);
        $arrParams[] = OrmObjectlistInOrEmptyRestriction::NULL_OR_EMPTY;
        $objRestriction = new OrmObjectlistInOrEmptyRestriction("foo", $arrParams);
        $strWhere = $objRestriction->getStrWhere();

        $this->assertEquals(" AND ((foo IN (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?) OR foo IN (?,?)) OR (foo IS NULL OR foo = '')) ", $strWhere);
        $this->assertEquals(count($arrParams), substr_count($strWhere, "?"));
    }
