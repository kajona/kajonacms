...
class class_graph_pchart implements interface_graph {
    ...
    private function preGraphCreation() {
        ...
        $this->objChart->setFontProperties(_corepath_."/module_system/system".$this->strFont, 8);
        ...
        if($this->intCurrentGraphMode == $this->GRAPH_TYPE_LINE) {
            ...
            //the zero-line
            $this->objChart->setFontProperties(_corepath_."/module_system/system".$this->strFont, 6);
        ...
        // Finish the graph
        $this->objChart->setFontProperties(_corepath_."/module_system/system".$this->strFont, 7);
        ...
        //draw the title
        if($this->strGraphTitle != "") {
        $this->objChart->setFontProperties(_corepath_."/module_system/system".$this->strFont, 10);
