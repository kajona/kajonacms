...
class class_modul_user_sourcefactory {
    ...
    public function getGroupByName($strName) {
        ...
        if(isset($arrRow["group_id"]) && validateSystemid($arrRow["group_id"])) {
            return new class_modul_user_group($arrRow["group_id"]);
        }
     ...
     * 
     * @param class_modul_user_group $objLeightweightGroup 
     * @return interface_usersources_group
     */
	public function getSourceGroup(class_modul_user_group $objLeightweightGroup) {
