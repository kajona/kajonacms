 ...
 * So make sure to pass the later operations as an additional cache param when creating an instance of Image:
 * $objImage = new Image($strInlayText.$intTextXPos.$intTextYPos).
