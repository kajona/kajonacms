...
KAJONA.admin.lang.fetchProperties = function(){
    ...
    KAJONA.admin.ajax.genericAjaxCall("system", "fetchProperty", "&target_module=" + encodeURIComponent(arrData.module), function(strResponse) {
        var arrData = KAJONA.admin.lang.queue.shift();
        var objResp = JSON.parse(strResponse);
