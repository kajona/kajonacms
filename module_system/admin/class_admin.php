...
abstract class class_admin {
	...
	protected $arrModule;			        //Array containing information about the current module
	protected $strTemplateArea;		        //String containing the current Area for the template-object //FIXME: required?
