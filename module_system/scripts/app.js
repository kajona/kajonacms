...
require(['jquery', 'jqueryui', 'jquery-touchPunch', 'bootstrap', 'v4skin', 'loader', 'dialog', 'folderview', 'lists'], function(jquery, jqueryui, touch, bootstrap, v4skin, loader, Dialog, folderview, lists) {
