...
//---Kajona head parts, please leave them as they are----------------------------------------------------
    ...
    $arrGlobal["kajona_head"]          .= "    <script type=\"text/javascript\">KAJONA_LANGUAGE = '".\Kajona\System\System\Carrier::getInstance()->getObjLang()->getStrTextLanguage()."'; KAJONA_WEBPATH = '"._webpath_."'; KAJONA_BROWSER_CACHEBUSTER = '".\Kajona\System\System\SystemSetting::getConfigValue("_system_browser_cachebuster_")."'; KAJONA_PHARMAP = ".json_encode(array_values(\Kajona\System\System\Classloader::getInstance()->getArrPharModules())).";</script>\n";
