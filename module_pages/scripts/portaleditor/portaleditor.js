...
//@ sourceURL=/core/module_pages/scripts/kajona_portaleditor.js
...
KAJONA.admin.portaleditor = {
    ...
    initPortaleditor : function() {
        ...
        CKEDITOR_BASEPATH = KAJONA_WEBPATH+"/core/module_system/scripts/ckeditor/";
        if(KAJONA_PHARMAP && KAJONA.util.inArray("module_system", KAJONA_PHARMAP)) {
            CKEDITOR_BASEPATH = KAJONA_WEBPATH+"/files/extract/module_system/scripts/ckeditor/";
        }


        KAJONA.admin.loader.loadFile([
            "/core/module_system/scripts/ckeditor/ckeditor.js"
        ], function() {
...
KAJONA.admin.tooltip = {
    initTooltip : function() {
        KAJONA.admin.loader.loadFile(['/core/module_system/scripts/qtip2/jquery.qtip.min.js', '/core/module_system/scripts/qtip2/jquery.qtip.min.css'], function() {
