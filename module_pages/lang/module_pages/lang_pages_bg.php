...
$lang["quickhelp_list_all"]              = "В този списък, всички страници са показват и структурата към папките им е игнорирана и скрита.<br />С този списък можете да намерите страницата, която търсите бързо.";
