...
JS;
    ...
    protected function actionListElements()
    {
        ...
        $objArraySectionIterator->setArraySection(PagesElement::getObjectListFiltered(null, "", $objArraySectionIterator->calculateStartPos(), $objArraySectionIterator->calculateEndPos()));
