...
<form name="formUserdata" method="post" action="%%formaction%%" accept-charset="UTF-8">
    %%formErrors%%
    <div><label for="username">[lang,usernameTitle,elements]</label><input type="text" name="username" id="username" value="%%username%%" class="inputText" disabled="disabled" /></div><br />
    <div><label for="password">[lang,passwordTitle,elements]</label><input type="password" name="password" id="password" value="%%password%%" class="inputText" /></div><br />
    <div><label for="password2">[lang,passwordTitle2,elements]</label><input type="password" name="password2" id="password2" value="%%password2%%" class="inputText" /></div><br />
    <div><label for="email">[lang,emailTitle,elements]</label><input type="text" name="email" id="email" value="%%email%%" class="inputText" /></div><br />
    <div><label for="forename">[lang,forenameTitle,elements]</label><input type="text" name="forename" id="forename" value="%%forename%%" class="inputText" /></div><br />
    <div><label for="name">[lang,nameTitle,elements]</label><input type="text" name="name" id="name" value="%%name%%" class="inputText" /></div><br />
    <div><label for="Submit"></label><input type="submit" name="Submit" value="[lang,userDataSubmit,elements]" class="button" /></div><br />
...
<form name="formUserdata" method="post" action="%%formaction%%" accept-charset="UTF-8">
    ...
    <div><label for="forename">[lang,forenameTitle,elements]</label><input type="text" name="forename" id="forename" value="%%forename%%" class="inputText" /></div><br />
    <div><label for="name">[lang,nameTitle,elements]</label><input type="text" name="name" id="name" value="%%name%%" class="inputText" /></div><br />
    <div><label for="street">[lang,streetTitle,elements]</label><input type="text" name="street" id="street" value="%%street%%" class="inputText" /></div><br />
    <div><label for="postal">[lang,postalTitle,elements]</label><input type="text" name="postal" id="postal" value="%%postal%%" class="inputText" /></div><br />
    <div><label for="city">[lang,cityTitle,elements]</label><input type="text" name="city" id="city" value="%%city%%" class="inputText" /></div><br />
    <div><label for="phone">[lang,phoneTitle,elements]</label><input type="text" name="phone" id="phone" value="%%phone%%" class="inputText" /></div><br />
    <div><label for="mobile">[lang,mobileTitle,elements]</label><input type="text" name="mobile" id="mobile" value="%%mobile%%" class="inputText" /></div><br />
