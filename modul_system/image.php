...
* 																										*
* 	image.php                                                                                           *
*   class to create on-the-fly image resizing                                                           *
*																										*
*-------------------------------------------------------------------------------------------------------*
*	$Id$                                                    *
********************************************************************************************************/
...
/**
 * This class could be used to create fast "on-the-fly" resizes of images.
 ...
 * If used with jpeg-pictures, the param quality=[1-95] colud be used, default is 90
 *
 * To create a captch image, you can call this class like
 * _webpath_/image.php?image=kajonaCaptcha
 *
 * The images are sent directly to the browser. So include the calling in img-tags
 *
 * ATTENTION:
 * Make sure to use urlencoded image-paths!!!
 * The params width and height both needn't to be used.
 *
...
class class_flyimage {
    ...
    public function __construct() {
        ...
        $this->intMaxHeight = urldecode(getGet("maxHeight"));
        if($this->intMaxHeight == "")
            $this->intMaxHeight = 0;

        $this->intMaxWidth = urldecode(getGet("maxWidth"));
        if($this->intMaxWidth == "")
            $this->intMaxWidth = 0;

        $this->intQuality = urldecode(getGet("quality"));
        if($this->intQuality== "")
            $this->intQuality = 90;
    ...
    public function generateImage() {
        ...
        $intWidthNew = 0;
		$intHeightNew = 0;
		if(is_file(_realpath_.$this->strFilename)) {
    ...
    public function generateCaptchaImage() {
        ...
        $this->objImage->sendImageToBrowser(90);
