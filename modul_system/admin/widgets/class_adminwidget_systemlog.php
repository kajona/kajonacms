...
*-------------------------------------------------------------------------------------------------------*
* 																										*
* 	class_adminwidget_systemlog.php																		*
* 	widget showing a few rows of the current systemlog													*																				*
*																										*
*-------------------------------------------------------------------------------------------------------*
*	$Id: class_adminwidget_systemlog.php 1735 2007-10-05 19:45:00Z sidler $		                        *
********************************************************************************************************/
...
class class_adminwidget_systemlog extends class_adminwidget implements interface_adminwidget {
    ...
    public function getWidgetOutput() {
        ...
        for($intI = 0; $intI <= $this->getFieldValue("nrofrows") && $intI < 10; $intI++ ) {
            ...
            $strLog = uniStrReplace(array("INFO", "ERROR"), array("<span style=\"color: green\">INFO</span>", "<span style=\"color: red\">ERROR</span>"), $strLog);
