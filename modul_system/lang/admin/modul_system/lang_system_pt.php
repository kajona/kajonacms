...
$lang["about_part1"]                     = "<h2>Kajona V3 - Sistema de Gestão de Conteúdos em Código Aberto</h2>Kajona V 3.1.9 (V3.2.0 ALPHA), Nome de código \"balsamico\"<br /><br /><a href=\"http://www.kajona.de\" target=\"_blank\">www.kajona.de</a><br /><a href=\"mailto:info@kajona.de\" target=\"_blank\">info@kajona.de</a><br /><br />Para mais informações, suporte ou sugestões, Por favor visite o nosso endereço.<br />Suporte adicional é dado no nosso <a href=\"http://board.kajona.de/\" target=\"_blank\">fórum</a>.";
$lang["about_part2"]                     = "<h2>Responsável do projecto</h2><ul><li><a href=\"mailto:sidler@kajona.de\" target=\"_blank\">Stefan Idler</a> (gestão de projecto, administração técnica, desenvolvimento)</li><li><a href=\"mailto:jschroeter@kajona.de\" target=\"_blank\">Jakob Schröter</a> (administração painel cliente, desenvolvimento)</li></ul><h2>Contribuições / Programadores</h2><ul><li>Thomas Hertwig</li><li><a href=\"mailto:tim.kiefer@kojikui.de\" target=\"_blank\">Tim Kiefer</a></li></ul>";
