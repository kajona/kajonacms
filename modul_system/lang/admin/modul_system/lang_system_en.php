...
$lang["installer_dbdriver_available"]    = "The database-driver selected is available on the system.";
$lang["installer_dbdriver_na"]           = "We are sorry, but the selected database-driver is not available on the system. Please install the following PHP-extension in oder to use the driver:";
$lang["installer_dbdriver_oci8"]         = "Attention: The Oracle-driver is still under development.";
$lang["installer_dbdriver_sqlite3"]      = "The SQLite-driver creates a database stored at /system/db. Therefore the databasename is used as the filename, all other values are not taken into account.";
