...
$text["_bildergalerie_cachepfad_"]          = "Cache path:";
...
$text["update_nofilefound"]         = "The list of updates failed to load.<br />Possible reasons can be having the php-config value
                                       'allow_url_fopen' set to 'off' or using a system without support for sockets.";
...
$text["quickhelp_systemSettings"]	= "You can define basic settings of the system. Therefore, every module is allowed to provide any number of settings.
...
$text["installer_login_intro"]      = "<b>Set up admin-user</b><br /><br />";
$text["installer_login_intro"]     .= "Please provide a username and a password.<br />Those will be used later to log in to the administration.<br />Because of security reasons, usernames like \"admin\" or \"administrator\" should be avoided.<br /><br />";
...
$text["installer_config_intro"]     .= "<br />In the case you want to use emtpy values, edit the config-file /system/config.php manually using a text-editor. For further informations, refer to the manual.<br /><br />";
