...
$text["dialog_deleteHeader"]        = "Confirm deletion";
$text["dialog_deleteButton"]        = "Yes, delete";
$text["dialog_cancelButton"]        = "cancel";
...
$text["_system_mod_rewrite_hint"]           = "Activates/deactivates URL-rewriting for nice-URLs. The apache-module \"mod_rewrite\" has to be installed and activated in the .htaccess file to use this option!";
...
$text["_system_lock_maxtime_"]              = "Maximum locktime:";
...
$text["_system_output_gzip_hint"]           = "Activates GZIP-compression of outputs before sending them to the client. Better: Activate compression settings in the .htaccess file.";
