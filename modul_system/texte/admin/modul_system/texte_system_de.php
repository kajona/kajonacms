...
$text["_bildergalerie_cachepfad_"]          = "Cache-Pfad:";
...
$text["_system_output_gzip_hint"]           = "Aktiviert das Komprimieren der Ausgaben per gzip, bevor diese an den Client gesendet werden.";
...
$text["about_part1"]                = "<h2>Kajona V3 - Open Source Content Management System</h2>
									   ...
									   Support erhalten Sie auch in unserem <a href=\"http://board.kajona.de/index.php?c=7\" target=\"_blank\">Forum</a>.
                                       ";
...
$text["installer_config_intro"]     .= "<br />Für den Fall, dass sie einen dieser Werte leer lassen wollten, bearbeiten Sie bitte manuell die Datei /system/config.php mit einem Texteditor, näheres hierzu im Handbuch.<br /><br />";
