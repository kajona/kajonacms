...
* 																										*
* 	texte_user_de.php																					*
* 	Admin language file for module_user  																*
*																										*
*-------------------------------------------------------------------------------------------------------*
*	$Id$                                            *
********************************************************************************************************/
...
$text["user_loeschen"]				= "Benutzer löschen";
$text["user_loeschen_frage"]		= " : Benutzer wirklich löschen?";
$text["user_loeschen_link"]			= "Löschen";
...
$text["gruppe_loeschen"]			= "Gruppe löschen";
$text["gruppe_loeschen_frage"]		= " : Gruppe wirklich löschen?";
$text["gruppe_loeschen_link"]		= "Löschen";
$text["gruppe_loeschen_erfolg"]		= "Löschen";
$text["gruppe_loeschen_fehler"]		= "Löschen";
...
$text["mitglied_loeschen_link"]		= "Entfernen";
