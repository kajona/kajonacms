...
*-------------------------------------------------------------------------------------------------------*
* 																										*
* 	class_modul_news_search.php                                                                         *
* 	Search-plugin of the news-module                                                                    *
*																										*
*-------------------------------------------------------------------------------------------------------*
*	$Id: class_modul_news_search.php 1530 2007-05-05 22:01:39Z sidler $                                  *
********************************************************************************************************/
			...
			if(count($arrNews) > 0) {
				foreach($arrNews as $arrOneNews) {
					...
					if(isset($this->arrHits[$arrOneNews["system_id"]]["hits"]))
    					...
    					$this->arrHits[$arrOneNews["system_id"]]["pagelink"] = getLinkPortal(_news_suche_seite_, "", "_self", $arrOneNews["news_title"], "newsDetail", "&highlight=".$this->strSearchtermRaw, $arrOneNews["system_id"]);
    					$this->arrHits[$arrOneNews["system_id"]]["pagename"] = _news_suche_seite_;
