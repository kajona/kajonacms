...
* 	Admin-class of the postacomment          															*
*																										*
*-------------------------------------------------------------------------------------------------------*
*	$Id: class_modul_postacomment_admin.php 1487 2007-04-10 19:34:56Z sidler $                          *
********************************************************************************************************/
...
class class_modul_postacomment_admin extends class_admin implements interface_admin {
	...
	public function getOutputModuleNavi() {
        ...
        if($this->objRights->rightView($this->getModuleSystemid($this->arrModule["modul"])))
    	    $arrReturn[] = getLinkAdmin($this->arrModule["modul"], "list", "", $this->getText("module_list"), "", "", true, "adminnavi") ."";
		return $arrReturn;
	}
