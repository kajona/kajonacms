...
class class_element_postacomment extends class_element_admin implements interface_admin_element {
	...
	public function getEditForm($arrElementData)	{
		...
		if(count($arrTemplates) == 1)
            $this->addOptionalFormElement($this->objToolkit->formInputDropdown("char1", $arrTemplatesDD, $this->getText("postacomment_template"), (isset($arrElementData["char1"]) ? $arrElementData["char1"] : "" )));
        else
        ...
        $strReturn .= $this->objToolkit->formInputText("int1", $this->getText("postacomment_numberofposts"), (isset($arrElementData["int1"]) ? $arrElementData["int1"] : "" ));
