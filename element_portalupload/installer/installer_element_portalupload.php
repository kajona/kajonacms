...
class class_installer_element_portalupload extends class_installer_base implements interface_installer {
	...
	public function hasPostInstalls() {
	    //needed:  downloads
	    try {
		    class_modul_system_module::getModuleByName("downloads");
		}
    ...
    public function postUpdate() {
        ...
        if(class_modul_pages_element::getElement("portalupload")->getStrVersion() == "3.3.0") {
        ...
        if(class_modul_pages_element::getElement("portalupload")->getStrVersion() == "3.3.1") {
            $strReturn .= $this->postUpdate_331_340();
            $this->objDB->flushQueryCache();
        }

        if(class_modul_pages_element::getElement("portalupload")->getStrVersion() == "3.4.0") {
