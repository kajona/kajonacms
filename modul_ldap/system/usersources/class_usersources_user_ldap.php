...
s     *
    ...
    public function updateObjectToDb($strPrevId = false) {
        if($this->getSystemid() == "") {
            ...
            class_logger::getInstance()->addLogRow("new ldap user: ".$this->getStrDN(), class_logger::$levelInfo);
            ...
            class_logger::getInstance()->addLogRow("updated user ".$this->getStrDN(), class_logger::$levelInfo);
