...
class class_workflow_ldap_sync implements interface_workflows_handler  {
    ...
    public function getConfigValueNames() {
        return array(
            class_carrier::getInstance()->getObjText()->getText("workflow_ldapsync_val1", "ldap", "admin")
        );
    }
    ...
    public function getStrName() {
        return class_carrier::getInstance()->getObjText()->getText("workflow_ldapsync_title", "ldap", "admin");
    }
