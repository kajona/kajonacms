...
echo "\nchecking group memberhships given...\n";
var_dump($objLdap->isUserMemberOfGroup("CN=Otto Onsen,OU=Verwaltung,OU=Accounts,DC=testad1,DC=local", "CN=Non-Management,OU=Groups,DC=testad1,DC=local"));
echo "checking group memberhships not given...\n";
var_dump($objLdap->isUserMemberOfGroup("CN=Otto Onsen,OU=Verwaltung,OU=Accounts,DC=testad1,DC=local", "CN=Management,OU=Groups,DC=testad1,DC=local"));
...
var_dump($objLdap->authenticateUser("Otto Onsen", "oo1"));
echo "authenticating real dummy-user...\n";
var_dump($objLdap->authenticateUser("Otto Onsen", "oo"));

echo "\nauthenticating false dummy-user with username...\n";
var_dump($objLdap->authenticateUser("oo@testad1.local", "oo1"));
echo "authenticating real dummy-user with username...\n";
var_dump($objLdap->authenticateUser("oo@testad1.local", "oo"));



echo "\nauthenticating false dummy-user with context...\n";
var_dump($objLdap->authenticateUser("Otto Onsen", "oo", "OU=Marketing,OU=Accounts,DC=testad1,DC=local"));
echo "authenticating real dummy-user with context...\n";
var_dump($objLdap->authenticateUser("Otto Onsen", "oo", "OU=Verwaltung,OU=Accounts,DC=testad1,DC=local"));


echo "\nsearching details of given user...\n";
var_dump($objLdap->getUserdetailsByName("Peter Pansen"));
var_dump($objLdap->getUserdetailsByName("P Pansen"));
