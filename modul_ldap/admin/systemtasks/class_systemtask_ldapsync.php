...
class class_systemtask_ldapsync extends class_systemtask_base implements interface_admin_systemtask {
    ...
    public function getStrTaskName() {
    	return $this->getText("systemtask_ldapsync_name");
    }
    ...
    public function executeTask() {
    	...
    	if($bitSync)
            return $this->objToolkit->getTextRow($this->getText("systemtask_ldapsync_success"));
        else
            return $this->objToolkit->getTextRow($this->getText("systemtask_ldapsync_error"));
    }
