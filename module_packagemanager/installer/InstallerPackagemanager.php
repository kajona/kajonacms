...
class InstallerPackagemanager extends InstallerBase implements InstallerInterface {
    ...
    public function update() {
        ...
        if($arrModule["module_version"] == "5.0.1") {
            ...
            $this->updateModuleVersion($this->objMetadata->getStrTitle(), "5.0.2");
        }

        $arrModule = SystemModule::getPlainModuleData($this->objMetadata->getStrTitle(), false);
        if($arrModule["module_version"] == "5.0.2") {
            $strReturn .= "Updating to 5.0.3...\n";
            $this->updateModuleVersion($this->objMetadata->getStrTitle(), "5.0.3");
        }

        $arrModule = SystemModule::getPlainModuleData($this->objMetadata->getStrTitle(), false);
        if($arrModule["module_version"] == "5.0.3") {
            $strReturn .= "Updating to 5.0.4...\n";
            $this->updateModuleVersion($this->objMetadata->getStrTitle(), "5.0.4");
        }
