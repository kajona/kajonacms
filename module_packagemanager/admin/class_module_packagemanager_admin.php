...
class class_module_packagemanager_admin extends class_admin_simple implements interface_admin {
    ...
    protected function actionList() {
        ...
        $objArraySectionIterator->setArraySection(class_module_packagemanager_template::getAllTemplatepacks($objArraySectionIterator->calculateStartPos(), $objArraySectionIterator->calculateEndPos()));
    ...
    protected function renderStatusAction(class_model $objListEntry) {
        if($objListEntry->rightEdit()) {
            if(_packagemanager_defaultpack_ == $objListEntry->getStrName()) {
