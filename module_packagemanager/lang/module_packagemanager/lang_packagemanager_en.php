...
$lang["pack_copy_include"]               = "Please choose the templates you want to copy to the new template pack. You just need to copy templates which you want to change. Templates not present in a template pack will be read from the default template pack.<br />The templates home.tpl and standard.tpl of the pages module are checked per default. They are used by the sample content and are the first files you will customize.<br />Additional templates can be copied later if required.";
