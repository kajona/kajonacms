...
*-------------------------------------------------------------------------------------------------------*
*	$Id: class_modul_search_portal.php 3962 2011-07-03 12:10:54Z sidler $                                *
********************************************************************************************************/
...
class class_module_search_portal extends class_portal implements interface_portal {
	...
	protected function actionSearch() {
		...
		foreach($arrHitsFilter["arrData"] as $arrHit) {

            if($arrHit["pagename"] == "master")
                continue;

            $objPage = class_module_pages_page::getPageByName($arrHit["pagename"]);
