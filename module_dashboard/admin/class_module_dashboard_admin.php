    ...
    protected function layoutAdminWidget($objDashboardWidget) {
        ...
        $strWidgetContent .= $this->objToolkit->getDashboardWidgetEncloser(
            ...
            $this->objToolkit->getAdminwidget(
                ...
                $strWidgetName,
                $strGeneratedContent,
                ($objDashboardWidget->rightEdit() ? getLinkAdminDialog("dashboard", "editWidget", "&systemid=".$objDashboardWidget->getSystemid(), "", $this->getLang("editWidget"), "icon_edit.png", $objDashboardWidget->getConcreteAdminwidget()->getWidgetName()) : ""),
