...
*-------------------------------------------------------------------------------------------------------*
*	$Id: class_stats_report_topcountries.php 4141 2011-10-17 15:53:15Z sidler $                            *
********************************************************************************************************/
...
class class_stats_report_topcountries implements interface_admin_statsreports {
	...
	public function getReportTitle() {
	    return  $this->objTexts->getLang("topcountries", "stats", "admin");
	}
	...
	public function getReport() {
		...
		//HeaderRow
		$arrHeader[] = "#";
		$arrHeader[] = $this->objTexts->getLang("top_country_titel", "stats", "admin");
