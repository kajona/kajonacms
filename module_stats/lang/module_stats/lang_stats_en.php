...
$lang["export_failure"]                  = "An error occurred during the export.";
...
$lang["import_failure"]                  = "An error occurred during the import.";
...
$lang["intro_worker_lookup"]             = "Number of addresses to process: ";
$lang["intro_worker_lookupip2c"]         = "Therefore the PHP-option 'allow_url_fopen' has to be enabled.<br />Number of addresses to process: ";
$lang["modul_titel"]                     = "Stats";
$lang["modul_worker"]                    = "Worker";
$lang["module_description"]              = "This module makes use of jqPlot to generate graphs";
...
$lang["quickhelp_stats_common"]          = "The stats are providing an insight into the systems different logfiles. In those reports, all logfiles are analyzed and processed to grant different views to the data.";
$lang["quickhelp_stats_top_sessions"]    = "Lists the active sessions";
