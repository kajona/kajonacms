...
class class_element_absatz extends class_element_admin implements interface_admin_element {
	...
	public function getEditForm($arrElementData)	{
		...
		$strReturn .= $this->objToolkit->formInputText("absatz_link", $this->getText("absatz_link"), (isset($arrElementData["absatz_link"]) ? $arrElementData["absatz_link"] : ""), "inputText", getLinkAdminPopup("folderview", "pagesFolderBrowser", "&pages=1&form_element=absatz_link", $this->getText("browser"), $this->getText("browser"), "icon_externalBrowser.gif", 500, 500, "ordneransicht"));
		return $strReturn;
	}
