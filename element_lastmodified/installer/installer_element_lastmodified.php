...
class class_installer_element_lastmodified extends class_installer_base implements interface_installer {
    ...
    public function postUpdate() {
        $strReturn = "";
        if(class_modul_pages_element::getElement("lastmodified")->getStrVersion() == "3.2.0.9") {
            $strReturn .= $this->postUpdate_3209_321();
            $this->objDB->flushQueryCache();
        }

        if(class_modul_pages_element::getElement("lastmodified")->getStrVersion() == "3.2.1") {
        ...
        if(class_modul_pages_element::getElement("lastmodified")->getStrVersion() == "3.3.0.1") {
    ...
    public function postUpdate_3209_321() {
        $strReturn = "Updating element lastmodified to 3.2.1...\n";
        $this->updateElementVersion("lastmodified", "3.2.1");
        return $strReturn;
    }
