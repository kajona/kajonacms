...
class class_installer_postacomment extends class_installer_base implements interface_installer_removable {
    ...
    public function install() {
		...
		$this->objRights->addGroupToRight(class_module_system_setting::getConfigValue("_guests_group_id_"), $strSystemID, "right1");
		$this->objRights->addGroupToRight(class_module_system_setting::getConfigValue("_guests_group_id_"), $strSystemID, "right2");
