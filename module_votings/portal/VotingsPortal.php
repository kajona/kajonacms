...
class VotingsPortal extends PortalController implements PortalInterface
{
    ...
    public function actionList()
    {
        ...
        if ($objVoting->rightView()) {
                ...
                if ($objVoting->rightRight1()) {
                    ...
                    elseif (!$bitDatesAllow) {
                        ...
                        foreach (VotingsAnswer::getObjectList($objVoting->getSystemid()) as $objOneAnswer) {
                            ...
                            $strAnswers .= $this->objTemplate->fillTemplateFile($arrTemplate, "/module_votings/".$this->arrElementData["char2"], "voting_voting_option");
                        }
                        ...
                        $strVotingContent .= $this->objTemplate->fillTemplateFile($arrTemplate, "/module_votings/".$this->arrElementData["char2"], "voting_voting");
                    }
            ...
            elseif ($this->arrElementData["int1"] == 1) {
                //result mode
                ...
                foreach (VotingsAnswer::getObjectList($objVoting->getSystemid()) as $objOneAnswer) {
                    ...
                    $strAnswers .= $this->objTemplate->fillTemplateFile($arrTemplate, "/module_votings/".$this->arrElementData["char2"], "voting_result_answer");
                }

                $arrTemplate = array();
                $arrTemplate["voting_answers"] = $strAnswers;
                $arrTemplate["voting_hits"] = $intTotalVotes;
                $strVotingContent .= $this->objTemplate->fillTemplateFile($arrTemplate, "/module_votings/".$this->arrElementData["char2"], "voting_result");
            }
            ...
            $strReturn .= $this->objTemplate->fillTemplateFile($arrTemplate, "/module_votings/".$this->arrElementData["char2"], "voting_wrapper");
