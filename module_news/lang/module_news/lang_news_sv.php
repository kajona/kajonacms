...
$lang["actionListNewsFeed"]              = "RSS-Feeds";
$lang["actionNew"]                       = "Skapa nyhet";
$lang["actionNewNewsFeed"]               = "Ny RSS-feed";
$lang["backward"]                        = "Tillbaka";
$lang["browser"]                         = "Öppna filhanterare";
$lang["contentToolbar_content"]          = "Redigera innehåll";
$lang["contentToolbar_properties"]       = "Redigera grunddata";
$lang["delete_question"]                 = "Vil du verkligen radera nyheten &quot;<b>%%element_name%%</b>&quot;?";
$lang["editNewsFeed"]                    = "Redigera feed";
$lang["feed_amount"]                     = "Antal nyheter;";
$lang["feed_amount_hint"]                = "Antal nyheter per feed (0=obegränsat)";
$lang["feed_delete_question"]            = "Vill du verkligen radera feed &quot;<b>%%element_name%%</b>&quot;?";
...
$lang["languageset_currentlanguage"]     = "Denna nyhet har för närvarande knutits till följande språk:";
...
$lang["modul_titel2"]                    = "Nyhetsförvaltning - kategori";
...
$lang["quickhelp_editCat"]               = "För närvarande kan endast en titel anges för ny eller föreliggande kategori.";
$lang["quickhelp_editLanguageset"]       = "För att möjliggöra språkomställning av nyheter i portalen måste dessa grupperas i s.k. lanquagesets. Med hjälp av denna information kan Kajona möjliggöra omställning av språk.";
$lang["quickhelp_editNews"]              = "Vid redigering eller skapande av en nyhet kan dess grunddata anges. Till dessa hör bl.a. nyhetens titel. Vidare kan olika datum definieras:<ul><li>Startdatum: Från detta datum visas nyheten på portalen</li><li>Slutdatum: Från detta datum försvinner nyheten komplett från portalen, också från arkivet.</li><li>Arkivdatum: från detta datum flyttas nyheten till arkivvyn.</li></ul><p>I tillägg kan tillhörigheten till olika nyhetskategorier anges.</p>";
$lang["quickhelp_editNewsFeed"]          = "Med hjälp av detta formulär kan egenskaperna för aktuell eller ny feed ändras.<br />Sidan 'detaljvy' anropas därmed, när en prenumerant på nyhetsfeeden kallar på en feeds detaljpresentation. Med hjälp av inställningen 'kategori av feed' kan man begränsa visade nyhetsposter. <br />Feedens URL kan anges i fältet 'URL-titel till feed' t.ex.  /newsnfacts.rss. Titeln skall endast betstå av bokstäver och siffror (a-z, A-Z, 0-9).";
$lang["quickhelp_editNewscontent"]       = "Innehållet i en nyhet kan redigeras i denna vy.";
...
$lang["quickhelp_newCat"]                = "För närvarande kan endast en titel anges för en kategori.";
$lang["quickhelp_newNews"]               = "Vid redigering eller skapande av en nyhet kan dess grunddata anges. Till dessa hör bl.a. nyhetens titel. Vidare kan olika datum definieras:<ul><li>Startdatum: Från detta datum visas nyheten på portalen</li><li>Slutdatum: Från detta datum försvinner nyheten komplett från portalen, också från arkivet.</li><li>Arkivdatum: från detta datum flyttas nyheten till arkivvyn.</li></ul><p>I tillägg kan tillhörigheten till olika nyhetskategorier anges.</p>";
$lang["quickhelp_newNewsFeed"]           = "Med hjälp av detta formulär kan egenskaperna för aktuell eller ny feed ändras.<br />Sidan 'detaljvy' anropas därmed, när en prenumerant på nyhetsfeeden kallar på en feeds detaljpresentation. Med hjälp av inställningen 'kategori av feed' kan man begränsa visade nyhetsposter. <br />Feedens URL kan anges i fältet 'URL-titel till feed' t.ex.  /newsnfacts.rss. Titeln skall endast betstå av bokstäver och siffror (a-z, A-Z, 0-9).";
$lang["quickhelp_newsFeed"]              = "I denna del kan RSS-feederna hanteras. Listan innehåller alla RSS-feeds som finns i systemet.";
