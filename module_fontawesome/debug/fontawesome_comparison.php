...
$p2f["icon_text.png"]                       = "<i class='icon-file-text-alt'></i>";
$p2f["icon_textDisabled.png"]               = "<span class='icon-stack'><i class='icon-file-text-alt'></i><i class='icon-ban-circle icon-stack-base' style='color: red; '></i></span>";
