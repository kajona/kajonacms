...
<form name="formContact" method="post" action="%%formaction%%" accept-charset="UTF-8">
	...
	<div><label for="form_captcha">%%lang_formContact_code%%</label><input type="text" name="form_captcha" id="form_captcha" class="inputText" /></div><br />
	<div><label for="Reload"></label><input type="button" name="Reload" onclick="reloadCaptcha('kajonaCaptcha')" value="%%lang_formContact_newCode%%" class="button" /></div><br /><br />
