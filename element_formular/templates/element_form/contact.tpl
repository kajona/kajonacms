...
<form name="formContact" method="post" action="%%formaction%%" accept-charset="UTF-8">
	...
	<div><label for="kajonaCaptcha_contact"></label><span id="kajonaCaptcha_contact"><script type="text/javascript">KAJONA.portal.loadCaptcha('contact', 180);</script></span> (<a href="#" onclick="KAJONA.portal.loadCaptcha('contact', 180); return false;">%%lang_formContact_newCode%%</a>)</div><br />
	<div><label for="form_captcha">%%lang_formContact_code%%</label><input type="text" name="form_captcha" id="form_captcha" class="inputText" autocomplete="off" /></div><br /><br />
