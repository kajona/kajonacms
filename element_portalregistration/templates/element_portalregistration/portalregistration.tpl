...
<form name="formUserdata" method="post" action="%%formaction%%" accept-charset="UTF-8" autocomplete="off">
    ...
    <div><label for="kajonaCaptcha"></label><img id="kajonaCaptcha" src="_webpath_/image.php?image=kajonaCaptcha&amp;maxWidth=180" /> (<a href="#" onclick="reloadCaptcha('kajonaCaptcha'); return false;">%%lang_captcha_reload%%</a>)</div><br />
    <div><label for="form_captcha">%%lang_captcha_label%%</label><input type="text" name="form_captcha" id="form_captcha" class="inputText" /></div><br />
