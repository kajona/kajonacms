...
*-------------------------------------------------------------------------------------------------------*
*	$Id: class_element_portalregistration.php 3978 2011-07-07 16:02:36Z sidler $                        *
********************************************************************************************************/
...
class class_element_portalregistration_admin extends class_element_admin implements interface_admin_element {
	...
	public function getEditForm($arrElementData) {
		...
		if(count($arrTemplates) == 1)
            $this->addOptionalFormElement($this->objToolkit->formInputDropdown("portalregistration_template", $arrTemplatesDD, $this->getLang("template"), (isset($arrElementData["portalregistration_template"]) ? $arrElementData["portalregistration_template"] : "" )));
        else
		...
		$strReturn .= $this->objToolkit->formInputDropdown("portalregistration_group", $arrGroupsDD, $this->getLang("portalregistration_group"), (isset($arrElementData["portalregistration_group"]) ? $arrElementData["portalregistration_group"] : "" ));
		$strReturn .= $this->objToolkit->formInputPageSelector("portalregistration_success", $this->getLang("commons_page_success"), (isset($arrElementData["portalregistration_success"]) ? $arrElementData["portalregistration_success"] : ""));
