...
class class_installer_element_portalregistration extends class_installer_base implements interface_installer {
    ...
    public function postUpdate() {
        ...
        if(class_modul_pages_element::getElement("portalregistration")->getStrVersion() == "3.3.1") {
            $strReturn .= $this->postUpdate_331_340();
            $this->objDB->flushQueryCache();
        }

        if(class_modul_pages_element::getElement("portalregistration")->getStrVersion() == "3.4.0") {
    ...
    public function postUpdate_331_340() {
        $strReturn = "Updating element portalregistration to 3.4.0...\n";
