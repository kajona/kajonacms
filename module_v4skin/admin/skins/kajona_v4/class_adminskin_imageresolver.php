...
class class_adminskin_imageresolver implements interface_adminskin_imageresolver {
    ...
    private static $arrFAImages = array(
        ...
        "icon_disabled"                    => "<span class='icon-stack'><i class='icon-sign-blank '></i><i class='icon-flag icon-stack-base icon-stack-base-full' style='color: #FF0000; font-size: 60%'></i></span>",
        ...
        "icon_enabled"                     => "<span class='icon-stack'><i class='icon-sign-blank '></i><i class='icon-flag icon-stack-base icon-stack-base-full' style='color: green; font-size: 60%'></i></span>",
        ...
        "icon_key"                         => "<i class='icon-key'></i>",
        "icon_key_inherited"               => "<span class='icon-stack'><i class='icon-key'></i><i class='icon-circle-arrow-down icon-stack-base'></i></span>",
