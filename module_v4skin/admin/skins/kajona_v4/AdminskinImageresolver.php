...
class AdminskinImageresolver implements AdminskinImageresolverInterface {
    ...
    public static $arrFAImages = array(
        ...
        "icon_acceptDisabled"              => "<span class='kj-icon fa-stack'><i class='fa fa-check'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        ...
        "icon_bookLens"                    => "<span class='kj-icon fa-stack'><i class='fa fa-book'></i><i class='fa fa-search fa-stack-1x' ></i></span>",
        ...
        "icon_crop_accept"                 => "<span class='kj-icon fa-stack'><i class='fa fa-crop'></i><i class='fa fa-check fa-stack-1x' style='color: green'></i></span>",
        "icon_crop_acceptDisabled"         => "<span class='kj-icon fa-stack'><i class='fa fa-crop'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_delete"                      => "<i class='kj-icon fa fa-trash-o'></i>",
        "icon_deleteDisabled"              => "<span class='kj-icon fa-stack'><i class='fa fa-trash-o'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_deleteLocked"                => "<span class='kj-icon fa-stack'><i class='fa fa-trash-o'></i><i class='fa fa-lock fa-stack-1x' style='color: red'></i></span>",
        ...
        "icon_earthDisabled"               => "<span class='kj-icon fa-stack'><i class='fa fa-globe'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_edit"                        => "<i class='kj-icon fa fa-pencil'></i>",
        "icon_editDisabled"                => "<span class='kj-icon fa-stack'><i class='fa fa-pencil'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_editLocked"                  => "<span class='kj-icon fa-stack'><i class='fa fa-pencil'></i><i class='fa fa-lock fa-stack-1x' style='color: red'></i></span>",
        "icon_enabled"                     => "<i class='kj-icon fa fa-eye'></i>",
        "icon_event"                       => "<i class='kj-icon fa fa-calendar-o'></i>",
        "icon_eventLocked"                 => "<span class='kj-icon fa-stack'><i class='fa fa-calendar-o'></i><i class='fa fa-lock fa-stack-1x' style='color: red'></i></span>",
        ...
        "icon_folderActionLevelup"         => "<span class='kj-icon fa-stack'><i class='fa fa-folder-open-o'></i><i class='fa fa-arrow-circle-up fa-stack-1x' ></i></span>",
        "icon_folderActionOpen"            => "<span class='kj-icon fa-stack'><i class='fa fa-folder-open-o'></i><i class='fa fa-search fa-stack-1x' ></i></span>",
        ...
        "icon_installDisabled"             => "<span class='kj-icon fa-stack'><i class='fa fa-download'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_key"                         => "<span class='kj-icon fa-stack'><i class='fa fa-users'></i><i class='fa fa-star fa-stack-1x' style='color: #ffa500;'></i></span>",
        ...
        "icon_mailDisabled"                => "<span class='kj-icon fa-stack'><i class='fa fa-envelope-o'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        ...
        "icon_new_alias"                   => "<span class='kj-icon fa-stack'><i class='fa fa-plus-circle'></i><i class='fa fa-link fa-stack-1x'></i></span>",
        "icon_new_multi"                   => "<span class='kj-icon fa-stack'><i class='fa fa-plus-circle'></i><i class='fa fa-chevron-down fa-stack-1x'></i></span>",
        "icon_news"                        => "<i class='kj-icon fa fa-quote-left'></i>",
        "icon_page"                        => "<i class='kj-icon fa fa-file-o'></i>",
        "icon_pageLocked"                  => "<span class='kj-icon fa-stack'><i class='fa fa-file-o'></i><i class='fa fa-lock fa-stack-1x' style='color: red'></i></span>",
        "icon_page_alias"                  => "<span class='kj-icon fa-stack'><i class='fa fa-file-o'></i><i class='fa fa-chevron-right fa-stack-1x'></i></span>",
        ...
        "icon_textDisabled"                => "<span class='kj-icon fa-stack'><i class='fa fa-file-text-o'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_treeBranchOpen"              => "<span class='kj-icon fa-stack'><i class='fa fa-sitemap'></i><i class='fa fa-chevron-right fa-stack-1x'></i></span>",
        "icon_treeBranchOpenDisabled"      => "<span class='kj-icon fa-stack'><i class='fa fa-sitemap'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_treeLeaf"                    => "<i class='kj-icon fa fa-sitemap'></i>",
        "icon_treeLeaf_link"               => "<span class='kj-icon fa-stack'><i class='fa fa-sitemap'></i><i class='fa fa-link fa-stack-1x'></i></span>",
        "icon_treeLevelUp"                 => "<span class='kj-icon fa-stack'><i class='fa fa-sitemap'></i><i class='fa fa-chevron-up fa-stack-1x'></i></span>",
        "icon_treeRoot"                    => "<i class='kj-icon fa fa-sitemap'></i>",
        "icon_undo"                        => "<i class='kj-icon fa fa-undo'></i>",
        "icon_undoDisabled"                => "<span class='kj-icon fa-stack'><i class='fa fa-undo'></i><i class='fa fa-ban fa-stack-1x' style='color: red'></i></span>",
        "icon_update"                      => "<i class='kj-icon fa fa-cloud-download'></i>",
        "icon_updateDisabled"              => "<span class='kj-icon fa-stack'><i class='fa fa-cloud-download'></i><i class='fa fa-check fa-stack-1x' style='color: green'></i></span>",
        "icon_updateError"                 => "<span class='kj-icon fa-stack'><i class='fa fa-cloud-download'></i><i class='fa fa-exclamation-triangle fa-stack-1x'></i></span>",
        "icon_upload"                      => "<i class='kj-icon fa fa-upload'></i>",
        "icon_user"                        => "<i class='kj-icon fa fa-user'></i>",
        "icon_userswitch"                  => "<span class='kj-icon fa-stack'><i class='fa fa-user'></i><i class='fa fa-play fa-stack-1x'></i></span>",
        "icon_word"                        => "<i class='kj-icon fa fa-ms-word'></i>",
        "icon_workflow"                    => "<i class='kj-icon fa fa-cog'></i>",
        "icon_workflowExecuted"            => "<span class='kj-icon fa-stack'><i class='fa fa-cog'></i><i class='fa fa-check fa-stack-1x' style='color: green'></i></span>",
        "icon_workflowNew"                 => "<span class='kj-icon fa-stack'><i class='fa fa-cog'></i><i class='fa fa-star fa-stack-1x' style='color: orange'></i></span>",
        "icon_workflowScheduled"           => "<span class='kj-icon fa-stack'><i class='fa fa-cog'></i><i class='fa fa-pause fa-stack-1x'  '></i></span>",
        "icon_workflowTrigger"             => "<span class='kj-icon fa-stack'><i class='fa fa-cog'></i><i class='fa fa-play fa-stack-1x' ></i></span>",
