...
class class_installer {
	...
	public function configWizard() {
        ...
        if(!isset($_POST["write"])) {
            ...
            //configwizard_form
            $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "configwizard_form", true);
	...
	public function adminLoginData() {
	    ...
	    if($bitShowForm){
	        $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "loginwizard_form", true);
	...
	public function createModuleInstalls() {
        ...
        $strRows = "";
        $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_modules_row", true);
        $strTemplateIDInstallable = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_modules_row_installable", true);
        ...
        //wrap in form
        $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_modules_form", true);
	...
	public function installSamplecontent() {
        ...
        //wrap in form
        $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_samplecontent_form", true);
        $strReturn .= $this->objTemplates->fillTemplate(array("module_rows" => $strRows, "button_install" => $this->getLang("installer_install")), $strTemplateID);
	...
	public function getOutput() {
	    if($this->strLogfile != "") {
	        $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_log", true);
	    ...
	    $strProgress = "";
	    $strTemplateEntryTodoID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_progress_entry", true);
	    $strTemplateEntryCurrentID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_progress_entry_current", true);
	    $strTemplateEntryDoneID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_progress_entry_done", true);
	...
	public function getForwardLink($strHref) {
	    $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_forward_link", true);
	...
	public function getBackwardLink($strHref) {
	    $strTemplateID = $this->objTemplates->readTemplate("/core/installer/installer.tpl", "installer_backward_link", true);
