...
<search_form>
    ...
    <form name="searchform" method="post" action="%%action%%" accept-charset="UTF-8">
        <label for="searchterm">%%form_searchterm_label%%</label><input type="text" name="searchterm" id="searchterm" value="%%suche_term%%" class="inputTextShort" />
        <input type="submit" name="Submit" value="%%form_submit_label%%" class="buttonShort" />
    </form>
    </div>
</search_form>
