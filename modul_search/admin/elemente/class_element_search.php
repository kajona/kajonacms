   ...
   /**
	...
	public function getEditForm($arrElementData)	{
		...
		if(count($arrTemplates) == 1)
            $this->addOptionalFormElement($this->objToolkit->formInputDropdown("search_template", $arrTemplatesDD, $this->getText("template"), (isset($arrElementData["search_template"]) ? $arrElementData["search_template"] : "" )));
        else
            $strReturn .= $this->objToolkit->formInputDropdown("search_template", $arrTemplatesDD, $this->getText("template"), (isset($arrElementData["search_template"]) ? $arrElementData["search_template"] : "" ));
