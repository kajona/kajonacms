...
* 																										*
* 	texte_stats_de.php																					*
* 	Admin language file for module_stats																*
*																										*
*-------------------------------------------------------------------------------------------------------*
*	$Id$                                           *
********************************************************************************************************/
...
$text["task_csvExportIntro"]         = "Mit diesem Task werden in der Datenbank vorhandene Daten in eine CSV-Datei exportiert und anschließend aus der
                                        Datenbank gelöscht. Dies kann dann sinnvoll werden, wenn sich bereits viele Daten in der Datenbank angesammelt haben
                                        und hierdurch die Datenbank bereits recht groß geworden ist. Die exportierten Dateien können jederzeit wieder in die
                                        Datenbank reimportiert werden, z.B. um diese wieder in den Reports auszuwerten.";
...
$text["task_importFromCsvIntro"]     = "Mit Hilfe des aktuellen Tasks 'importFromCsv' können Datensätze, die in einer CSV-Datei vorliegen,
                                        in das System importiert werden. Nach dem Import stehen diese Daten dann wieder in allen Reports
                                        zur Verfügung.";
...
$text["quickhelp_worker"]            = "Worker werden für regelmäßige Aufgaben verwendet. Dazu gehört unter Anderem der Task 'IP-Adressen auflösen'. Durch Starten
                                        dieses Tasks werden alle IP-Adressen in der Datenbank durch ihre entsprechenden Hostnamen ersetzt, sofern dies möglich
                                        ist. Hierdurch werden die Statistiken an vielen Stellen besser lesbar.";

$text["quickhelp_statsCommon"]       = "Die Statistiken geben einen Einblick in die verschiedenen Logfiles des Systems. In diesen Reports werden alle Zugriffe
                                        auf das Portal in verschiedenen Darstellungen ausgewertet. Hierzu gehört eine Analyse der Benutzerzahlen, eine Auswertung der
                                        auf diese Seite verweisenden Links oder auch eine Auswertung der Browser.";
