 ...
 *
 * A handler should be capable to fullfill the following semantical contract:
 *
...
interface interface_workflows_handler {
    ...
    /**
     * This method is called right before the current workflow is saved to the database.
     * Use this method to set up all internal fields and initialize
     * the new-state.
     *
     * The workflow-object itself is updated automatically, so no need to be done right here.
     */
