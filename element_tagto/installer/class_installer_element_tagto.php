 ...
 */
class class_installer_element_tagto extends class_elementinstaller_base implements interface_installer {
	...
	public function update() {
        ...
        if(class_module_pages_element::getElement("tagto")->getStrVersion() == "4.3") {
            $strReturn .= "Updating element tagto to 4.4...\n";
            $this->updateElementVersion("tagto", "4.4");
            $this->objDB->flushQueryCache();
        }

        if(class_module_pages_element::getElement("tagto")->getStrVersion() == "4.4") {
            $strReturn .= "Updating element tagto to 4.5...\n";
            $this->updateElementVersion("tagto", "4.5");
            $this->objDB->flushQueryCache();
        }
