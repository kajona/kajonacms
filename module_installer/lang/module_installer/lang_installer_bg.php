...
$lang["installer_phpcheck_intro2"]       = "<br />Инсталацията на системата е разделенa в няколко стъпки: <br /><li><b>Проверка на правата.</b></li><li><b>Конфигурация на база данни.</b></li><li><b>Пълномощия за достъп до администрацията.</b></li><li><b>Инсталация на модули.</b></li><li><b>Инсталация на елементи.</b></li><li><b>Инсталация на пробно съдържание.</b></li><br /><br />В зависимост от избраните модули за инсталиране, броя на стъпките варира.<br /><br /><br /><br />Правата върху някой файлове и достъпът <br />на нужните php-модули проверени:<br />";
