...
class class_modul_languages_admin extends class_admin implements interface_admin {
	...
	public function getOutputModuleNavi() {
		...
		if($this->objRights->rightEdit($this->getModuleSystemid($this->arrModule["modul"])))
		    $arrReturn[] = getLinkAdmin($this->arrModule["modul"], "newLanguage", "", $this->getText("modul_anlegen"), "", "", true, "adminnavi") ."";
		$arrReturn[] = "";
		if($this->objRights->rightEdit($this->getModuleSystemid($this->arrModule["modul"])))
		    $arrReturn[] = getLinkAdmin($this->arrModule["modul"], "assignNullElements", "", $this->getText("modul_assign"), "", "", true, "adminnavi") ."";
		return $arrReturn;
	}
