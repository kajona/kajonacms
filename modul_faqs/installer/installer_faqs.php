...
class class_installer_faqs extends class_installer_base implements interface_installer {
   ...
   public function install() {
    ...
    private function update_330_3301() {
        ...
        $strReturn .= "Setting cache-timeouts for faqs-element...\n";
        ...
        $strReturn .= "Updating element-versions...\n";
        $this->updateElementVersion("faqs", "3.3.0.1");
        return $strReturn;
    }
    ...
    private function update_3301_331() {
        ...
        $strReturn .= "Updating module-versions...\n";
        $this->updateModuleVersion("faqs", "3.3.1");
        $strReturn .= "Updating element-versions...\n";
        $this->updateElementVersion("faqs", "3.3.1");
        return $strReturn;
    }
