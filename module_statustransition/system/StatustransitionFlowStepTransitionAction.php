...
/**
 * StatustransitionFlowStepTransitionAction
 *
 * @author christoph.kappestein@artemeon.de
 * @targetTable flow_step_transition_action.action_id
 * @module statustransition
 * @moduleId _statustransition_module_id_
 * @formGenerator Kajona\Statustransition\Admin\StatustransitionStepTransitionActionFormgenerator
 */
abstract class StatustransitionFlowStepTransitionAction extends Model implements ModelInterface, AdminListableInterface, StatustransitionActionInterface
{
    /**
     * @var string
