 ...
 */
class class_module_eventmanager_todo_provider implements interface_todo_provider
{
    ...
    {
        return array(
            "eventmanager_events" => class_lang::getInstance()->getLang("calendar_filter_event", "eventmanager"),
        );
    }
